...
export default function Hero() {
  return (
    <section>
      {/* Eyebrow strip */}
      <div className="flex items-center justify-between border-b border-atl-divider px-14 py-5 font-atl-mono text-[11px] tracking-[0.16em] text-atl-muted">
        <span>Vol. 06 — Issue 04</span>
        <span className="font-atl-serif text-[18px] italic tracking-[0] text-atl-ink">
      ...
      <div className="grid min-h-[720px] grid-cols-[1.1fr_1fr]">
        {/* Left: text */}
        <div className="flex flex-col justify-between px-14 pb-16 pt-20">
          ...
          <div className="grid grid-cols-[1.5fr_1fr] items-end gap-6">
        ...
        <div className="relative min-h-[720px] border-l border-atl-divider">
          <Image
      ...
      {/* Stats strip */}
      <div className="grid grid-cols-4 border-b border-t border-atl-divider">
        {stats.map((s, i) => (
          <div
            key={s.label}
            className={`px-8 py-7 ${i < 3 ? "border-r border-atl-divider" : ""}`}
          >
